<?php
  ...
  if ($numero==1) 
  { 
    $consulta = "SELECT * FROM agencias WHERE EMPRESA = 'MRW' AND (EMPRESA LIKE '%$term%' 
  ...
  { 
    ...
    FROM agencias WHERE MATCH (EMPRESA,COD_AGE,NOM_AGE,DIR_AGE,EST_AGE,CIU_AGE) AGAINST ('$term' IN BOOLEAN MODE ) AND EMPRESA = 'MRW' HAVING relevancia > 0.2 ORDER BY relevancia DESC LIMIT 0,10";
  }    
