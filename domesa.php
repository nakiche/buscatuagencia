...
<head>
<meta charset="utf-8">
<title>Encontrar agencias oficinas agentes sucursales de envío DOMESA - Buscatuagencia.com.ve</title>
<meta property="og:image" content=""/>
<meta property="og:image:width" content="1500" /> 
<meta property="og:image:height" content="574" />
<meta name="description" content="Encuetra tu agencia o sucursal de envío Domesa en Venezuela"/>
<meta name="keywords" content="Agencias de envío Domesa, sucursales de envío Domesa, oficinas de envío Domesa, Domesa, encuentra tu agencia, Venezuela"/>
      ...
      <div class="header">
        ...
        <div class="FBG">
          <div class="FBG_resize">
            ...
            <div class="logo2">
              <a><img src="images/logodomesa1.png" border="0" alt="logo"></a>
            </div>
  ...
  <?PHP    
    ...
    if(empty($_GET["filtro"]))  //valido si existe un filtro
    {
       ...
       if ($pagina !=1)
       {
          ...
          echo "<a href='domesa.php?searchterm=$busqueda&pagina=".($pagina-1)."'><strong><<</strong></a>";
       }                                                     
      ...
      { 
        if ($pagina == $i) 
          ...
          echo "<a href='domesa.php?searchterm=$busqueda&pagina=$i'>  $i </a>";
      }
    ...
    else //si hay un filtro
    {
         ...
         if ($pagina !=1)
       {
            ...
            echo "<a href='domesa.php?searchterm=$busqueda&filtro=$filtro&pagina=".($pagina-1)."'><strong><<</strong></a>";
       }                                                     
      ...
      { 
        if ($pagina == $i) 
          ...
          echo "<a href='domesa.php?searchterm=$busqueda&filtro=$filtro&pagina=$i'>  $i </a>";
      }
